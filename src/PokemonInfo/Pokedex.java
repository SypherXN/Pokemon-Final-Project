...
public class Pokedex {
	...
	public static final BasePokemon[] basePokemons = {
		...
		new BasePokemon(),
		new BasePokemon("Bulbasaur", Grass, Poison, 45, 49, 49, 45, 1, 2, 1, 1, 1, 16),
		new BasePokemon("Ivysaur", Grass, Poison, 60, 62, 63, 60, 2, 2, 2, 2, 2, 32),
		new BasePokemon("Venasaur", Grass, Poison, 80, 82, 83, 80, 3, 3, 2, 2, 2, 101),
		new BasePokemon("Charmander", Fire, NoType, 39, 52, 43, 65, 4, 2, 2, 2, 2, 16),
		new BasePokemon("Charmeleon", Fire, NoType, 58, 64, 58, 80, 5, 3, 2, 2, 2, 36),
		new BasePokemon("Charizard", Fire, Flying, 78, 84, 78, 100, 6, 3, 2, 2, 2, 101),
		new BasePokemon("Squirtle", Water, NoType, 44, 48, 65, 43, 7, 2, 2, 2, 2, 16),
		new BasePokemon("Wartortle", Water, NoType, 59, 63, 80, 58, 8, 3, 2, 2, 2, 36),
		new BasePokemon("Blastoise", Water, NoType, 79, 83, 100, 78, 9, 3, 2, 2, 2, 101),
		new BasePokemon("Caterpie", Bug, NoType, 45, 30, 35, 45, 10, 2, 1, 2, 2, 7),
		new BasePokemon("Metapod", Bug, NoType, 50, 20, 55, 30, 11, 3, 1, 2, 1, 10),
		new BasePokemon("Butterfree", Bug, Flying, 60, 45, 50, 70, 12, 3, 2, 2, 2, 101)/*,
		new BasePokemon("Weedle", Bug, Poison, 40, 35, 30, 50, 13, ),
		new BasePokemon("Kakuna", Bug, Poison, 45, 25, 50, 35, 25, 14),
		new BasePokemon("Beedrill", Bug, Poison, 65, 80, 40, 75, 15),
		new BasePokemon("Pidgey", Normal, Flying, 40, 45, 40, 56, 16),
		new BasePokemon("Pidgeotto", Normal, Flying, 63, 60, 55, 71, 17),
		new BasePokemon("Pidgeot", Normal, Flying, 83, 80, 75, 91, 18),
		new BasePokemon("Rattata", Normal, NoType, 30, 56, 35, 72, 19),
		new BasePokemon("Raticate", Normal, NoType, 55, 81, 60, 97, 20),
		new BasePokemon("Spearow", Normal, Flying, 40, 60, 30, 70, 21),
		new BasePokemon("Fearow", Normal, Flying, 65, 90, 65, 100, 22),
		new BasePokemon("Ekans", Poison, NoType, 35, 60, 44, 55, 23),
		new BasePokemon("Arbok", Poison, NoType, 60, 85, 69, 80, 24),
		new BasePokemon("Pikachu", Electric, NoType, 35, 55, 30, 90, 25),
		new BasePokemon("Raichu", Electric, NoType, 60, 90, 55, 100, 26),
		new BasePokemon("Sandshrew", Ground, NoType, 50, 75, 85, 40, 27),
		new BasePokemon("Sandslash", Ground, NoType, 75, 100, 110, 65, 28),
		new BasePokemon("Nidoran F", Poison, NoType, 55, 47, 52, 41, 29),
		new BasePokemon("Nidorina", Poison, NoType, 70, 62, 67, 56, 30),
		new BasePokemon("Nidoqueen", Poison, Ground, 90, 82, 87, 76, 31),
		new BasePokemon("Nidoran M", Poison, NoType, 46, 57, 40, 50, 32),
		new BasePokemon("Nidorino", Poison, NoType, 61, 72, 57, 65, 33),
		new BasePokemon("Nidoking", Poison, Ground, 81, 92, 77, 85, 34),
		new BasePokemon("Clefairy", Normal, NoType, 70, 45, 48, 35, 35),
		new BasePokemon("Clefable", Normal, NoType, 95, 70, 73, 60, 36),
		new BasePokemon("Vulpix", Fire, NoType, 38, 41, 40, 65, 37),
		new BasePokemon("Ninetales", Fire, NoType, 73, 76, 75, 100, 38),
		new BasePokemon("Jigglypuff", Normal, NoType, 115, 45, 20, 20, 39),
		new BasePokemon("Wigglytuff", Normal, NoType, 140, 70, 45, 45, 40),
		new BasePokemon("Zubat", Poison, Flying, 40, 45, 35, 55, 41),
		new BasePokemon("Golbat", Poison, Flying, 75, 80, 70, 90, 42),
		new BasePokemon("Oddish", Grass, Poison, 45, 50, 55, 30, 43),
		new BasePokemon("Gloom", Grass, Poison, 60, 65, 70, 40, 44),
		new BasePokemon("Vileplume", Grass, Poison, 75, 80, 85, 50, 45),
		new BasePokemon("Paras", Bug, Grass, 35, 70, 55, 25, 46),
		new BasePokemon("Parasect", Bug, Grass, 60, 95, 80, 30, 47),
		new BasePokemon("Venonant", Bug, Poison, 60, 55, 50, 45, 40, 48),
		new BasePokemon("Venomoth", Bug, Poison, 70, 65, 60, 90, 49),
		new BasePokemon("Diglett", Ground, NoType, 10, 55, 25, 95, 50),
		new BasePokemon("Dugtrio", Ground, NoType, 35, 80, 50, 120, 51)*/
